  ...
  'html': function(test) 
  {
    ...
    ([],
      function(result) 
      {
          ...
          helper.$file('html/dist/index.html',function (window,$)
          {
          ...
          helper.$file('html/dist/new1.html',function (window,$)
          {
          ...
          helper.$file('html/dist/new2.html',function (window,$)
          {
          ...
          helper.$file('html/dist/new3.html',function (window,$)
          {
          ...
          helper.$file('html/dist/new4.html',function (window,$)
          {
          ...
          helper.$file('html/dist/new5.html',function (window,$)
          {
          ...
          helper.$file('html/dist/new6.html',function (window,$)
          {
